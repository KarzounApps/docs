---
title: "Dropbox"
description: "Bearer-token file storage MiniApp example with actions and triggers."
---

A file storage integration with bearer token auth, 9 actions, and 5 triggers.
