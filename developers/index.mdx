...
<Info>
  Looking for day-to-day product how-tos? Start from the [docs home](/) or [Help Center](/help-center) — this section is for builders. If the GraphQL gateway is down for everyone, check [Status](https://status.karzoun.chat/).
</Info>
...
| Embed UI in the inbox | **Dashboard SDK** | iframe apps calling `executeAction` (host → `executeMiniAppAction`) |
