...
3. Download the public SDL anytime: `https://YOUR_SUBDOMAIN.api.karzoun.chat/public-api.graphql`
4. Prefer the schema reference in this tab for field and type docs
