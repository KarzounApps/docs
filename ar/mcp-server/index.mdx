...
امنح مساعدي الذكاء الاصطناعي **وصولًا منظمًا** إلى مساحة عمل كرزون — العملاء، الوسوم، المنتجات، المستخدمون، خطافات الويب، والمزيد — عبر [Model Context Protocol](https://modelcontextprotocol.io/).
...
- [مركز المطوّرين](/ar/developers) — الواجهة البرمجية، خطافات الويب، ساحة التجربة
