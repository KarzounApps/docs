...
يحوّل MCP المستضاف حساب كرزون إلى **أدوات حية** لوكلاء الذكاء الاصطناعي السحابيين — نفس عمليات GraphQL التي تستخدمها في [ساحة التجربة](https://karzoun.chat/developer/playground)، معروضة كأدوات MCP مسماة يمكن لنموذج اللغة استدعاؤها نيابة عنك.
...
| **البريد الوارد**          | `conversations`، `conversationMessageAdd`      | قراءة المحادثات، صياغة أو إرسال ردود (ضمن نطاق التطبيق)  |
